...
\[L(X, \theta)  = f(X_1, \theta) \cdot \ldots \cdot f(X_n, \theta) = \frac{1}{\theta^n} \xrightarrow{} \max_{\theta > 0}\]

Значит $\hat{\theta}$ должна быть наименьшей возможной, $x\in[0,\theta] \Rightarrow \hat{\theta} = max(X_1, \ldots, X_n)$ 
\end{enumerate}
