...
\begin{enumerate}[resume]
  ...
  если она продаёт кокошники по себестоимости и вероятность покупки любого из них одна и та же. \textbf{(5 баллов)}
	...
	\[ \text{Пусть} \ X_1, \ldots, X_5 -- \text{цены кокошников.} \ \E (X_i) = 3500, \Var (X_i) = 500^2 = 250000, \ i = 1, \ldots , 5. \]

 \[ \text{Василиса выбирает наугад и равновероятно 3 кокошника, обозначим их цены за} \  Y_1, Y_2, Y_3. \] 
