...
\begin{enumerate} 
\item	
$\gamma = 95\%$\quad Следовательно\quad $\alpha / 2 = 0.025$ 
...
\[
T_{\mbox{табл}} < T_{\mbox{расчёт}}\quad \text{Следовательно гипотеза}\quad H_0\quad \text{отвергается}\quad
\]
...
\[	
LR = -2 \cdot (l(\hat \theta_R)-l(\hat \theta_{UR})) \sim \chi^2 (r)\quad  \text{здесь}\quad \chi_3^2
\]
...
\[
\frac{\delta l}{\delta p} = \frac{40}{p_1} + \frac{50}{p_2} + \frac{10}{p_3}\quad \text{получаем:}\quad \hat p_i = \frac{a_i}{n}
\]
...
\[
LR_{\mbox{табл}} > LR_{\mbox{расчёт}}\quad \text{Следовательно гипотеза}\quad H_0\quad \text{не отвергается}\quad
\]
...
\[	
W_n = \sum_{i=1}^r\frac{(\nu_i - n \cdot p_i)^2}{n \cdot p_i}\sim \chi^2 (r-1)\quad \text{здесь}\quad \chi_2^2
\]
...
\[
W_{\mbox{табл}} > W_{\mbox{расчёт}}\quad  \text{Следовательно гипотеза}\quad H_0\quad \text{не отвергается}\quad
\]	
\end{enumerate} 
