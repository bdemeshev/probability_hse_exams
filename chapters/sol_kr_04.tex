...
\begin{enumerate} 
\item	
$\gamma = 95\%$ Следовательно $\alpha / 2 = 0.025$ 
...
\[
T_{\text{расчёт}} = \frac{\bar x - p}{\sqrt{\frac{\bar x \cdot (1 - \bar x) }{n}}} = \frac{0.1 - 0.01}{\sqrt{\frac{0.1 \cdot 0.9}{100}}} = 3 
\]

Заметим, что $T_{\text{табл}} < T_{\text{расчёт}}$, поэтому гипотеза $H_0$ отвергается.
...
Заметим, что $LR_{\text{табл}} > LR_{\text{расчёт}}$, поэтому гипотеза $H_0$ не отвергается.
...
\[
W_{\text{расчёт}} = \frac{(40 - 100 \cdot \frac{3}{7})^2}{100 \cdot \frac{3}{7}} + \frac{(50 - 100 \cdot \frac{3}{7})^2}{100 \cdot \frac{3}{7}} + \frac{(10 - 100 \cdot \frac{1}{7})^2}{100 \cdot \frac{1}{7}} \approx 2.58 
\]
...
Заметим, что $W_{\text{табл}} > W_{\text{расчёт}}$, поэтому гипотеза $H_0$ не отвергается.	
\end{enumerate} 
