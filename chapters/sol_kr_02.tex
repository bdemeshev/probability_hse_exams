...
\begin{enumerate}
    ...
    $$\P(A \ge 15) = \P\biggl(\dfrac{A - \E(A)}{\sqrt{\Var(A)}} \ge \dfrac{15 - \E(A)}{\sqrt{\Var(A)}}\biggl) 
    = \P\biggl(\dfrac{A - 25}{\sqrt{12.5}} \ge -2.83\biggl)$$
    
    Согласно ЦПТ, $\dfrac{A - 25}{\sqrt{12.5}} \sim N(0, 1)$, значит $\P\biggl(\dfrac{A - 25}{\sqrt{12.5}} \ge -2.83\biggl) = 0.9977$
    ...
    Согласно ЦПТ, $\dfrac{Z + 5}{\sqrt{24.5}} \sim N(0, 1)$, значит $\P\biggl(\dfrac{Z + 5}{\sqrt{24.5}} > 1.01\biggl) = 0.1562$
\end{enumerate}
