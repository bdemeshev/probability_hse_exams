...
% \usepackage{fancyhdr} % настройка заголовков страниц
\usepackage{titleps} % заголовки страниц

% \usepackage{titlesec} % настройка поведения при начале section
% конфликтует с fancyhdr
...
% начинаем каждую секцию с новой страницы и убираем все колонтитулы
% \newcommand{\sectionbreak}{\clearpage\thispagestyle{empty}}
% пакет titlesec конфликтует с fancyhdr
